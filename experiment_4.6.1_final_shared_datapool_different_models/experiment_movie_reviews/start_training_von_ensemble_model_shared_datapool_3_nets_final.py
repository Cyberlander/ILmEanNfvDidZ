...
if __name__ == "__main__":
    ...
    for i in range(20):
        ...
        HOLDOUT_SIZE = 0.2
        #HOLDOUT_SIZE = 0.5
        _, X_holdout, _, y_holdout = train_test_split( X_sources_sentences, y_label, test_size=HOLDOUT_SIZE, random_state=42)
    ...
    with open( "verlauf_3_nets_1_testset_final.txt", "w" ) as f:
