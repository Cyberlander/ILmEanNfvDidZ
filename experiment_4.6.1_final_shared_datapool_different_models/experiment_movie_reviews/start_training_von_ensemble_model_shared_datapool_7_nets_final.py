...
if __name__ == "__main__":
    ...
    nn_model_6 = neural_network_module.get_gru_model( INPUT_VECTOR_DIM  )
    nn_model_7 = neural_network_module.get_cnn_model( SEQUENCE_LEN,INPUT_VECTOR_DIM, NUM_CLASSES  )
    ...
    RECALLS = []
    F1S = []
    DATAPOOL_PATH = "../../datasets_for_experiments/movie_reviews_20_growing_dataset/movie_reviews_complete_datapool_shuffled.csv"
    DATAPOOL_PATH = "C:/Users/Felix/Desktop/Studium/_Master/Masterarbeit/_Coding/datasets_for_experiments/movie_reviews_20_growing_dataset/movie_reviews_complete_datapool_shuffled.csv"
    X_sources_sentences_complete, y_label_complete = get_data_for_nn_meta_function( DATAPOOL_PATH, SEQUENCE_LEN, INPUT_VECTOR_DIM )
    ...
    with open( "verlauf_7_nets_testset_1_final.txt", "w" ) as f:
