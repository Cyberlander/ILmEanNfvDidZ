...
if __name__ ==  "__main__":
    print()
    df_verlauf_1 = pd.read_csv("no_datapool_verlauf_yahoo_5_nets_next_timestep_1.csv",delimiter=";")
    df_verlauf_2 = pd.read_csv("no_datapool_verlauf_yahoo_5_nets_next_timestep_2.csv",delimiter=";")
    df_verlauf_3 = pd.read_csv("no_datapool_verlauf_yahoo_5_nets_next_timestep_3.csv",delimiter=";")
    df_verlauf_4 = pd.read_csv("no_datapool_verlauf_yahoo_5_nets_next_timestep_4.csv",delimiter=";")
    df_verlauf_5 = pd.read_csv("no_datapool_verlauf_yahoo_5_nets_next_timestep_5.csv",delimiter=";")
    ...
    MEAN_PRE_4 = get_mean_value_from_dataframes( dataframes, 'precision_class_3' )
    MEAN_REC_4 = get_mean_value_from_dataframes( dataframes, 'recall_class_3' )
    MEAN_F1_4 = get_mean_value_from_dataframes( dataframes, 'f1_class_3' )
    ...
    print('precision_class_3: ',MEAN_PRE_4   )
    print('recall_class_3: ',MEAN_REC_4   )
    print('f1_class_3: ',MEAN_F1_4   )
