...
if __name__ == "__main__":
    ...
    #with open( "verlauf_yahoo_3_nets_next_timestep_1.txt", "w" ) as f:
    ...
    df_evaluation_matrix.to_csv( "no_datapool_verlauf_yahoo_3_nets_next_timestep_1.csv", sep=";", index=None )
