...
def get_data_for_nn_meta_function( datapath, sequence_len, input_vector_dim ):
    ...
    source_sentences, label = data_io.load_yahoo_data_from_csv( datapath )
...
def fill_evaluation_matrix( evaluation_matrix,  acc, precisions, recalls, f1s):
    ...
    evaluation_matrix[i-1][10] = precisions[3]
    evaluation_matrix[i-1][11] = recalls[3]
    evaluation_matrix[i-1][12] = f1s[3]
    return evaluation_matrix

if __name__ == "__main__":
    #DATABASE_PATH = 'db/yahoo_data_sentiment_classification.csv'
    DATAPOOL_DATABASE_PATH = "../../datasets_for_experiments/expert_annotations_date_splitted/expert_annotations_{}.csv"
    ...
    ACCURACIES = []
    evaluation_matrix = np.zeros((34,13))
    for i in range(1,35):
        print("\n--------------------[ {} ]--------------------".format( i ))

        if i == 1:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_3, y_label_3 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        elif i == 2:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_3, y_label_3 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        elif i == 3:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_3, y_label_3 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        elif i == 4:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_3, y_label_3 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-3), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-3), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        else:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_3, y_label_3 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-3), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( DATAPOOL_DATABASE_PATH.format(i-4), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        X_TEST, y_TEST = get_data_for_nn_meta_function( "../../datasets_for_experiments/expert_annotations_date_splitted/expert_annotations_{}.csv".format(i+1), SEQUENCE_LEN, INPUT_VECTOR_DIM)
        ...
        h4 = nn_model_4.fit( X_sources_sentences_4, y_label_4, epochs=EPOCHS, batch_size=BATCH_SIZE )
        h5 = nn_model_5.fit( X_sources_sentences_5, y_label_5, epochs=EPOCHS, batch_size=BATCH_SIZE )
    ...
    df_evaluation_matrix = pd.DataFrame(evaluation_matrix, columns=['accuracy', 'precision_class_0', 'recall_class_0', 'f1_class_0','precision_class_1', 'recall_class_1', 'f1_class_1',
      'precision_class_2', 'recall_class_2', 'f1_class_2', 'precision_class_3', 'recall_class_3', 'f1_class_3'])
    df_evaluation_matrix.to_csv( "no_datapool_verlauf_yahoo_5_nets_next_timestep_1.csv", sep=";", index=None )
