...
if __name__ ==  "__main__":
    print()
    df_verlauf_1 = pd.read_csv("no_datapool_verlauf_facebook_3_nets_next_timestep_1.csv",delimiter=";")
    df_verlauf_2 = pd.read_csv("no_datapool_verlauf_facebook_3_nets_next_timestep_2.csv",delimiter=";")
    df_verlauf_3 = pd.read_csv("no_datapool_verlauf_facebook_3_nets_next_timestep_3.csv",delimiter=";")
    df_verlauf_4 = pd.read_csv("no_datapool_verlauf_facebook_3_nets_next_timestep_4.csv",delimiter=";")
    df_verlauf_5 = pd.read_csv("no_datapool_verlauf_facebook_3_nets_next_timestep_5.csv",delimiter=";")
