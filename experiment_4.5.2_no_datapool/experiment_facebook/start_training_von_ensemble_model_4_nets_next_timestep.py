...
if __name__ == "__main__":
    ...
    for i in range(1,51):
        ...
        X_train_meta = np.concatenate( ( X_train_meta_1, X_train_meta_2, X_train_meta_3, X_train_meta_4 ), axis=1 )
        ...
        X_test_meta = np.concatenate( ( X_test_meta_1, X_test_meta_2, X_test_meta_3, X_test_meta_4), axis=1 )
    ...
    #with open( "verlauf_yahoo_4_nets_next_timestep_1.txt", "w" ) as f:
    ...
    df_evaluation_matrix.to_csv( "no_datapool_verlauf_facebook_4_nets_next_timestep_1.csv", sep=";", index=None )
