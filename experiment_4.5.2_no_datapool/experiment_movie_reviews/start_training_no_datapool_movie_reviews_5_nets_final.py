...
if __name__ == "__main__":
    ...
    for i in range(20):
        ...
        if i == 0:
            ...
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        elif i == 1:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            ...
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        elif i == 2:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            ...
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        elif i == 3:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_3, y_label_3 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-3), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-3), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        else:
            X_sources_sentences_1, y_label_1 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_2, y_label_2 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-1), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_3, y_label_3 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-2), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_4, y_label_4 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-3), SEQUENCE_LEN, INPUT_VECTOR_DIM )
            X_sources_sentences_5, y_label_5 = get_data_for_nn_meta_function( CHUNK_DATABASE_PATH.format(i-4), SEQUENCE_LEN, INPUT_VECTOR_DIM )
        ...
        X_train_2, X_holdout_2, y_train_2, y_holdout_2 = train_test_split( X_sources_sentences_2, y_label_2, test_size=0.2, random_state=42)
        X_train_3, X_holdout_3, y_train_3, y_holdout_3 = train_test_split( X_sources_sentences_3, y_label_3, test_size=0.2, random_state=42)
        X_train_4, X_holdout_4, y_train_4, y_holdout_4 = train_test_split( X_sources_sentences_4, y_label_4, test_size=0.2, random_state=42)
        X_train_5, X_holdout_5, y_train_5, y_holdout_5 = train_test_split( X_sources_sentences_5, y_label_5, test_size=0.2, random_state=42)
        ...
        h3 = nn_model_3.fit( X_train_3, y_train_3, epochs=EPOCHS, batch_size=BATCH_SIZE )
        h4 = nn_model_4.fit( X_train_4, y_train_4, epochs=EPOCHS, batch_size=BATCH_SIZE )
        h5 = nn_model_5.fit( X_train_5, y_train_5, epochs=EPOCHS, batch_size=BATCH_SIZE )
        end_time = time.time()
        end_time = time.time()
    ...
    with open( "no_datapool_verlauf_5_nets_1_testset.txt", "w" ) as f:
