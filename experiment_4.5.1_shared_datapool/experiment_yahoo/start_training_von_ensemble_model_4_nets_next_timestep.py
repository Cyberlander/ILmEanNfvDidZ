...
if __name__ == "__main__":
    ...
    DATAPOOL_DATABASE_PATH = "../../datasets_for_experiments/expert_annotations_date_splitted/expert_annotations_pool_{}.csv"
    ...
    for i in range(1,35):
        ...
        HOLDOUT_PERCENT = 0.2
        _, X_holdout, _, y_holdout = train_test_split( X_sources_sentences, y_label, test_size=HOLDOUT_PERCENT, random_state=42)
    ...
    df_evaluation_matrix.to_csv( "verlauf_yahoo_4_nets_next_timestep_1.csv", sep=";", index=None )
